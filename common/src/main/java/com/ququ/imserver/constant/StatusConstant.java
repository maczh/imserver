...
public enum StatusConstant {
        ...
        USER_UNAVAILABLE(2002,"IM账户尚未注册"),
        USER_LOGIN_FAIL(2003,"登录失败，密码错误"),
        SHOP_UNAVAILABLE(2004,"商户编号不存在"),
        USER_IS_NOT_STAFF_OF_SHOP(2005,"用户不是此商户的员工"),
        CONTACT_STAFF_UNAVAILABLE(2006,"商户没有客服员工"),
        TAGS_PARAMS_ERROR(3001,"标签接口参数错误"),
        ...
        private StatusConstant(int code, String msg){
            this.code=code;
            this.msg=msg;
        }
    ...
    public static String getErrorMsg(int code){
            for (StatusConstant neaseImErrorCode : StatusConstant.values()){
